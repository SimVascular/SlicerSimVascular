# ----------------------------------------------------------------------------
# This file is a Python port of geometry3Sharp's `Remesher`, `RemesherPro`, `MeshConstraints`,
# `MeshConstraintUtil`, `DCurveProjectionTarget` and `MeshProjectionTarget`, and is a
# derivative work of that library.
#
#   geometry3Sharp -- https://github.com/gradientspace/geometry3Sharp
#   "Open-Source (Boost-license) C# library for geometric computing."
#   Copyright (c) Ryan Schmidt / gradientspace <https://www.gradientspace.com>
#
# geometry3Sharp states no copyright notice in its LICENSE file, and none in the
# source files this port was taken from; the line above records the authorship
# its README gives, so that the attribution travels with the code. Its licence is
# reproduced in full below because that licence requires it of a derivative work
# distributed in source form, and it is reproduced *here*, rather than only in
# NOTICE.txt, so that this file carries its own terms if it is ever copied out of
# the package alone.
#
# NOTICE.txt beside this package says which files here are ports and which are
# not, and records what geometry3Sharp in turn credits to others.
#
...
#
# Code in this file that did not come from geometry3Sharp is under the project's
# own licence in LICENSE.txt. Nothing here restricts the rights geometry3Sharp's
# licence grants in the ported portions.
#
